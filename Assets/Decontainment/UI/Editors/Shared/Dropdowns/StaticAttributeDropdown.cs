...
namespace Editor
{
    /// Static dropdowns can't have their options changed
    public abstract class StaticAttributeDropdown<T, TL, A> : MonoBehaviour
    ...
    where A : class // Attribute
    {
        ...
        protected abstract A[] AttributeArray { get; }
